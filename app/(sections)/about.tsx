...
export default function About() {
  return (
    ...
    >
      <h1
        className={`animate-slidein opacity-0 [--slidein-delay:300ms] text-white text-6xl font-bold font-sans`}
      >
        Hi, I’m Romel Rey Silva
      </h1>
      <h3 className='animate-slidein opacity-0 [--slidein-delay:500ms] text-[#00B2EB] font-bold text-5xl'>
        Frontend Developer
      </h3>
      <h5 className='animate-slidein opacity-0 [--slidein-delay:700ms] text-white text-xl font-bold'>
